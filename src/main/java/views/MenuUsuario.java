...
public class MenuUsuario extends JFrame {
	...
	public MenuUsuario() {
		...
		btnUsuarios.setBounds(0, 369, 257, 56); // Ajusta la posición según tus necesidades
		btnUsuarios.setBackground(new Color(12, 138, 199));
		panelMenu.add(btnUsuarios);
		btnUsuarios.setLayout(null);

		JLabel lblUsuarios = new JLabel("Usuarios");
		lblUsuarios.setIcon(new ImageIcon(MenuUsuario.class.getResource("/imagenes/pessoas.png"))); // Cambia "/ruta/a/imagen.png" a la ruta de la imagen que quieras usar
		lblUsuarios.setBounds(27, 11, 200, 34);
		lblUsuarios.setHorizontalAlignment(SwingConstants.LEFT);
		lblUsuarios.setForeground(Color.WHITE);
		lblUsuarios.setFont(new Font("Roboto", Font.PLAIN, 18));
		btnUsuarios.add(lblUsuarios);
