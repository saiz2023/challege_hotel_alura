...
public class Login extends JFrame {
	...
	private void iniciarsesion() {
	    ...
	    char[] contraseñaChars = txtContrasena.getPassword();
	    String contraseña = new String(contraseñaChars);

	    if (!txtUsuario.getText().isEmpty() && contraseñaChars.length > 0) {
	        Boolean login = usuariodao.comprobarlogin(txtUsuario.getText(), contraseña);
