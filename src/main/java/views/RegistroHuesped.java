...
public class RegistroHuesped extends JFrame {
		...
		btnguardar.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				if (!txtNombre.getText().isEmpty() && !txtApellido.getText().isEmpty() && txtFechaN.getDate() != null && !txtTelefono.getText().isEmpty()) {		
					...
					huespedes huesped = new huespedes(txtNombre.getText(), txtApellido.getText(), txtFechaN.getDate(),(String) txtNacionalidad.getSelectedItem(),
					 ...
					 EntityManager em = JPAUtils.getEntityManager();
			            ...
			            System.out.println("id de huespedes == "+huesped.getId());
	...
	//Código que permite mover la ventana por la pantalla según la posición de "x" y "y"	
	 private void headerMousePressed(java.awt.event.MouseEvent evt) {
	    ...
	    public void setReservaYId(reservas reserva, long reservaId) {
